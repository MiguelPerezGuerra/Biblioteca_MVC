...
namespace Biblioteca_MVC.Controllers
{
    public class AutoresController : Controller
    {
        ...
        public AutoresController(DbbibliotecaV2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string buscar)
        {
              ...
              //            Problem("Entity set 'DbbibliotecaV2Context.Autores'  is null.");
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,FechaNacimiento,PaisOrigen")] Autore autore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,FechaNacimiento,PaisOrigen")] Autore autore)
        {
            if (id != autore.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DbbibliotecaV2Context.Autores'  is null.");
            }
            var autore = await _context.Autores.FindAsync(id);
            if (autore != null)
            {
