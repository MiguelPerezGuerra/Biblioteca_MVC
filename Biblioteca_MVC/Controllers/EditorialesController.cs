...
namespace Biblioteca_MVC.Controllers
{
    public class EditorialesController : Controller
    {
        ...
        public EditorialesController(DbbibliotecaV2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string buscar)
        {
              ...
              //            Problem("Entity set 'DbbibliotecaV2Context.Editoriales'  is null.");
            var editorial = from Editoriales in _context.Editoriales select Editoriales;

            if (!string.IsNullOrEmpty(buscar))
            {
                editorial = editorial.Where(s=>s.Nombre!.Contains(buscar));
            }

            return View(await editorial.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Direccion,Telefono,CorreoElectronico")] Editoriale editoriale)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Direccion,Telefono,CorreoElectronico")] Editoriale editoriale)
        {
            if (id != editoriale.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DbbibliotecaV2Context.Editoriales'  is null.");
            }
            var editoriale = await _context.Editoriales.FindAsync(id);
            if (editoriale != null)
            {
